...
QT_MOC_LITERAL(1, 6, 10), // "avaChanged"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "titleChanged"
QT_MOC_LITERAL(4, 31, 6), // "avaUrl"
QT_MOC_LITERAL(5, 38, 5) // "title"

    },
    "Group\0avaChanged\0\0titleChanged\0avaUrl\0"
    "title"
};
...
void Group::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Group::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Group::avaChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Group::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Group::titleChanged)) {
                *result = 1;
                return;
            }
        }
