...
QT_MOC_LITERAL(3, 25, 6), // "images"
QT_MOC_LITERAL(4, 32, 4) // "stop"

    },
    "ImagesLoadThread\0loaded\0\0images\0stop"
};
...
void ImagesLoadThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loaded((*reinterpret_cast< QList<QVariant>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ImagesLoadThread::*)(QList<QVariant> );
...
// SIGNAL 0
void ImagesLoadThread::loaded(QList<QVariant> _t1)
{
