...
QT_MOC_LITERAL(3, 24, 3) // "url"
    ...
    "ImageLoader\0urlChanged\0\0url"
};
...
static const uint qt_meta_data_ImageLoader[] = {
 ...
 // properties: name, type, flags
       3, QMetaType::QString, 0x00095000,
...
void ImageLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLoader::urlChanged)) {
                *result = 0;
                return;
            }
        }
